...
class SceneFlowDatasets(StereoDataset):
    def __init__(self, aug_params=None, root='/mnt/Datasets/Sceneflow/', dstype='frames_finalpass', things_test=False):
...
class ETH3D(StereoDataset):
    def __init__(self, aug_params=None, root='/mnt/Datasets/ETH3D', split='training'):
        super(ETH3D, self).__init__(aug_params, sparse=True)

        image1_list = sorted( glob(osp.join(root, f'{split}/*/im0.png')) )
        image2_list = sorted( glob(osp.join(root, f'{split}/*/im1.png')) )
        disp_list = sorted( glob(osp.join(root, 'training_gt/*/disp0GT.pfm')) ) if split == 'training' else [osp.join(root, 'two_view_training_gt/playground_1l/disp0GT.pfm')]*len(image1_list)
...
class KITTI(StereoDataset):
    def __init__(self, aug_params=None, root='/mnt/Datasets/KITTI/2015', image_set='training'):
        super(KITTI, self).__init__(aug_params, sparse=True, reader=frame_utils.readDispKITTI)
        assert os.path.exists(root)

        # root_12 = '/data/zhengdian/dataset/KITTI/2012'
        ...
        # root_15 = '/data/zhengdian/dataset/KITTI/2015'
        ...
        #
        root_15 = '/mnt/Datasets/KITTI/2015'
        image1_list = sorted(glob(os.path.join(root_15, image_set, 'image_2/*_10.png')))
        image2_list = sorted(glob(os.path.join(root_15, image_set, 'image_3/*_10.png')))
        disp_list = sorted(glob(os.path.join(root_15, 'training', 'disp_occ_0/*_10.png'))) if image_set == 'training' else [osp.join(root, 'training/disp_occ_0/000085_10.png')]*len(image1_list)
...
class Middlebury(StereoDataset):
    def __init__(self, aug_params=None, root='/mnt/Datasets/MiddEval3', split='F'):
